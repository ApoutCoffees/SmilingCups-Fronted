...
const handleLogin = async () => {
  ...
  if (success) {
    ...
    loginError.value = auth.errors.length > 0 ? auth.errors[0] : t('login.error');
  }
};
</script>
...
.logo-container p { font-family: 'Amaranth', sans-serif; font-size: 2rem; font-weight: bold; color: #2C1810; margin: 0; }
...
.auth-form h3 { text-align: center; font-family: 'Amaranth', sans-serif; font-size: 1.8rem; color: #2C1810; margin-top: 0; margin-bottom: 1.5rem;}
...
.form-options { color: #5c4b44; display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; font-family: 'Amaranth', sans-serif; font-size: 0.9rem; }
...
.auth-switch { color: #5c4b44; font-family: 'Amaranth', sans-serif; text-align: center; margin-top: 1.5rem; font-size: 0.9rem; }
