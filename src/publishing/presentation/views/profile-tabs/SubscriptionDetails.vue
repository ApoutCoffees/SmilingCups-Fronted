<script setup>
import { defineProps, defineEmits, computed } from 'vue'; // Add defineEmits
...
const emit = defineEmits(['cancel-subscription']); // Define the event
...
const handleCancelSubscription = () => {
  // Add a confirmation dialog for safety (optional but recommended)
  if (confirm("Are you sure you want to cancel your subscription? This cannot be undone immediately.")) {
    emit('cancel-subscription'); // Emit the event to the parent
  }
};
</script>
